...
Reads from `x` when the horizontal constraint is `CENTER`. See [ADR 041 — Layout Positioning](https://github.com/rudironsoni/specs/blob/main/adr/041-layout-positioning.md).
